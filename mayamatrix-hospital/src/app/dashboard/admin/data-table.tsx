...
export const columns: ColumnDef<User>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const appointmentTime: Date = row.getValue("appointmentTime");
      return (
        <div className="">{appointmentTime.toUTCString().slice(0, -3)}</div>
      );
    },
  },
  {
    ...
    cell: ({ row }) => <div className="">{row.getValue("doctorAssigned")}</div>,
  },
  {
    accessorKey: "email",
    header: "Email",
